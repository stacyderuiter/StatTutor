...
### Exercises
 ...
 2. What happens if you name the summaries? (Example: `a = min, b = max`.)
...
One nice things about `df_stats()` is that it returns a data frame.  This means we can use 
the results from `df_stats()` in our plots.
