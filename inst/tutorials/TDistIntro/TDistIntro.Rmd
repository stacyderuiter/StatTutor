...
*These materials come from your text book, [Intro to Modern Statistics Chapter 7](https://openintro-ims.netlify.app/inference-num.html#inference-num). Book sections corresponding to parts of this tutorial will be linked throughout; you are encouraged but not required to read them before or after completing the tutorial.*
...
## SE for a Mean
*Text book reference: [IMS Chapter 7.1.2](https://openintro-ims.netlify.app/inference-num.html#one-mean-math)*
...
*Text book reference: [IMS, "Introducing the t-distribution"](https://openintro-ims.netlify.app/inference-num.html#introducing-the-t-distribution)*
...
## Why it Matters
*Text book reference: [IMS section "Introducing the t-distribution"](https://openintro-ims.netlify.app/inference-num.html#introducing-the-t-distribution)*
...
*Text book reference: [IMS, "One sample t confidence intervals"](https://openintro-ims.netlify.app/inference-num.html#one-sample-t-confidence-intervals)*
...
## Tests for a Mean
*Text book reference: [IMS, "Tests for a mean"](https://openintro-ims.netlify.app/inference-num.html#one-sample-t-tests)*
...
## Conditions
*Text book reference: [IMS on conditions for the t model for a mean](https://openintro-ims.netlify.app/inference-num.html#evaluating-the-two-conditions-required-for-modeling-barx)*
...
So next week, we will learn to let R do all the work for tests for one and two proportion tests and CIs (using function `prop.test()`), and also for one mean, paired means, and two means (using function `t.test()`). So now you have something lovely to look forward to!
