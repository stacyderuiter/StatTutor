...
for people to read.
  ...
  * Feel free to use extra spaces to "line things up" to make them easier to read.
...
the relationship between two quantitative variables.  To make a differnt
...
#### Your turn
 ...
 2. Change `gf_dens()` to `gf_density()`.
 
 3. Can you make the density (use `gf_density()`) plot a different color and
 partly transparent?  That will make it easier to see the histogram.
 
 4. Replace `BPSysAve` with a different quantitative variable.
 ...
 * [Favorite Plots Google Slides](https://docs.google.com/presentation/d/1BPNAz5IkbSqzrI05Aaad73VwnE-FFw_mjP8ZCLZD8oo/edit?usp=sharing)

If you like you plots "just so", keep reading to learn some ways to 
customize your plots.  Then come back and tweak your plots.
...
in the course we will use it statistical modeling as well.)
