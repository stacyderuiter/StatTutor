...
How would you use the full `elephants` dataset to test whether the true proportion high-density sites is no more than 0.5?
...
prop.test(~NightSong | Year, data = robins,
          alternative = 'two.sided', success = ...)
```

```{r night-test-solution, eval = FALSE, echo = FALSE, results = 'hide'}
prop.test(~NightSong | Year, data = robins, 
          alternative = 'two.sided', success = 'Present')
```
