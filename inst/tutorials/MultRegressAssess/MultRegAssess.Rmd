...
- Also near the bottom of the summary output, the $R^2$ value is reported.  (If there is more than one predictor in the model, we prefer to use the adjusted $R^2$ value instead of the standard one.)
