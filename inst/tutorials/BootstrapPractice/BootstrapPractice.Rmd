...
The `obscene` data are pre-loaded for you in this tutorial, and also available at [http://www.calvin.edu/~sld33/data/obscenity.csv](http://www.calvin.edu/~sld33/data/obscenity.csv) and includes useful variables:
...
Mathieu Douhard and colleagues studied the effects of weather on reproductive success in reindeer. For reindeer, frequent rain-on-snow (ROS) is *bad* weather. The dataset `reindeer` (already loaded for you in this tutorial, or accessible at [http://www.calvin.edu/~sld33/data/reindeer.csv](http://www.calvin.edu/~sld33/data/reindeer.csv)) includes variables:
...
There are also examples of these calculations on [the class R reference site](http://rsconnect.calvin.edu:3939/connect/#/apps/94). (If there is something that should be there and isn't, let Prof DR know.)
