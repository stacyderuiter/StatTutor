...
There are also examples of these calculations on [an Intro STAT R reference site](https://rsconnect.calvin.edu:3939/connect/#/apps/142/access). (If there is something that should be there and isn't, let Prof DR know.)
